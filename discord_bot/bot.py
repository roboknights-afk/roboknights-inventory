...
SYSTEM_PROMPT_TEMPLATE = (
    ...
    "Kumar, or anyone else in the school's staff/administration - by name, "
    "nickname, title, or clear description. If a message asks about any of "
    "them, decline plainly (e.g. 'I don't talk about staff/admin here') "
